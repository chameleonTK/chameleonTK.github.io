...
{% include aligner.html images="https://lh3.googleusercontent.com/d/18EX2Asz63i3zL6jBMrXnDgywUx0jUbCg" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1E0vcLRCl82pw3vflmWFxe8OG4FExtImC" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1MilrMsMQ2JYm3m10qlhtV9u4WyD6Hh-N" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1N3CD7Jf-EvQBoTqJI_KlkQXj5J4Hvtb8" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1nfSE0NwEXsFj3zefdfaUlO1-xW7ly8xe" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1BYhZXBY_SLUoTTOwUWTP3VBuExPxojLV" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1-5AS0fo5a7E6IOzt3MNpa1QdxesNI7T5,https://lh3.googleusercontent.com/d/1EvTEL-LYJGWzK45DffhhTQ6a0sIGcbL9" column=2 %}


กลับมาในเมือง แวะให้รางวัลตัวเองด้วยขาหมูเยอรมัน กับ เบียร์ต้นฉบับๆจากเยอรมัน

{% include aligner.html images="https://lh3.googleusercontent.com/d/1vLMvzk_o067D__cK5IC1rcuH0S79OrRu" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/17L64d37eXmeeZjNx3fUyV2Ot6U_Pw40t" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1ExSXpijnwyXnKvube5peGVHa2HhJ9dx2" column=2 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1EQjXx7qxE6HiMfFxErh9-BTQ5lxpeGOb,https://lh3.googleusercontent.com/d/11VT5rPzHYXl7PrQPNYpiejJFzOZydwXz" column=2 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1rxXF1MkpUsao-4jq4h6l_P3mFFFReudi" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1ddjIXe-bvqlEkeF5OBeHzH3C9KIzm933" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1J8-Fy4aoYGsnMzKIbxwnu1Gh8EimQIWf" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1dpuDcnVzaxuTeDAlbG_Qu_fM1bWJ0t5F" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1gvKbXhrkb1t4MJsOlat9XsKQD2S-LP7I,https://lh3.googleusercontent.com/d/17Z_VH39OTrcch3x1a9wCYvQNghdi_rWl,https://lh3.googleusercontent.com/d/1LLXGod4ayJyPRmm8iY_qljSMTBu2HpMN,https://lh3.googleusercontent.com/d/1fNYTHf_rpSsx3ybt47Eg1oqec1koaXjH" column=2 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1peD5e9DbFn4xEOxQ_d9258cmDVxlLvZS" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1iogjTt1SrsnE467r8V7eFT1ywgz026K6" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1D0i8cMkEQO-27gjHhENavMArjcCQyb-n" column=1 %}
 

## วันที่ 6-9
เป็น 4 วันที่จริงจังกับการร่วมงานประชุมวิชาการ LREC2022 มันคือเป้าหมายของการเดินทางครั้งนี้(?) จริงจังไม่จริงโจ้ 

{% include aligner.html images="https://lh3.googleusercontent.com/d/1Hjd8gnO0CTCNGHWhdG4ug68KmA3oHKGB" column=1 %}

นี่มีพรีเซ้นตอนเช้าวันที่ 7 ทุกอย่างผ่านไปด้วยดี

{% include aligner.html images="https://lh3.googleusercontent.com/d/1WahZYFEeKBk7tVXsTsCm1nCiNMuYUN4-" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1OPTWvedx7AVQDEnFXie8visJPY3z49l4" column=1 %}

และดูอาหารเช้าของที่นี้

{% include aligner.html images="https://lh3.googleusercontent.com/d/14lwaBvc0TrNnswYnBRaN0Q9D7RTaR_Xu" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1GuaOWJtjW_CDMsnuhYYRA1Sj7hlGm8O4" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1mn6LjUXM9IqfVka_hFebcD3PQY0MdJxL,https://lh3.googleusercontent.com/d/1IcfX8TOJ3GgwFqgrXKqLEzsrZWMARHZO" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/15w7PJpWYgaF1s9PTLWM63X0rwxdON5q6" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1luLsNs1ILFuZ1cp8__Y2meSfUTEjnTcL" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1DC8FH87PTEWYJ5fpkvvnWzG7pE6k2bok" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1xw2rtdZ91p_zc_Q9xNJfDZ1lDLrYg8T8" column=1 %}

แล้วหลังจากนั้นอีก 2-3 วัน ได้ข้อตวามมาว่า คนจากงาน LREC2022 ติดโควิดกันรัวๆ //แต่นี่ก็ยังรอด #จบการเดินทาง

{% include aligner.html images="https://lh3.googleusercontent.com/d/1dYBwBap1VWS47S6QcZNjuYKyNfCjrEEw" column=1 %}
