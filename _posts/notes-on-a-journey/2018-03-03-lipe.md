...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1725uqutQqSr79nSG9Bb5EZJ8X02Q6YVJ" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/12BFu8LG1Q4jpzqvRgwDaV_dk-TKXLlfu" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1YsdrWODBt3JAPQjrpe7jry95LKAnlDS8" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1yXPojS_Fhr61_Fnsv2LWLnGBGJXsGKBv" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1FFv4yp7fwpx6cHiM561wFN8Shhe6VsAl" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1GkbAyLA6Ohi1K4zc8geFlM-yNCtwP_0S" column=1 %}
</div>
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1aozkvaHF1O0pQo4w94CIoqo4JFCPm2Hr" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1lWCSURYKeAphEIoknUawGT5v2TgjsUVm" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1ofv915XT2vWPSeW1AW2cmTR--pN4-Tm3" column=1 %}

ถ้าใครจะมา อย่าลืมเช็คเวลาดีๆ เพราะเรือมันมีแค่ไม่กี่รอบ

{% include aligner.html images="https://lh3.googleusercontent.com/d/1VZQ1dcOF0M4hFPdEZh-kEtLtNK5SovqJ" column=1 %}

ในที่สุด กลิ่นเกลือจากทะเล เริ่มโชยแตะจมูก

{% include aligner.html images="https://lh3.googleusercontent.com/d/1zE3j9P7yG3QfR4gHRu5lmLSo0HZ26cCF" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1H6eKPmVxYjGr2lT8QM4VyW_Se2lVejWo" column=1 %}

ถ่ายภาพหมู่กันซะหน่อย //อ่าวว ไหนๆทะเล

{% include aligner.html images="https://lh3.googleusercontent.com/d/1qeSvA9aY2WgTZdc2SVnA3qLybbxULUKW" column=1 %}

มุมโฆษณาประจำเกาะไข่ กับ ซุ้มหินรักนิรันดร หืมมมมม~ มองบน

{% include aligner.html images="https://lh3.googleusercontent.com/d/1AcH3i_gwLQUnkYbIWXRVITDinKSQiL7p" column=1 %}

หลักจากนั้นไม่นาน บ่ายๆ ก็ถึงชายฝั่งเกาะหลีเป๊ะ จุดหมายของเรา

{% include aligner.html images="https://lh3.googleusercontent.com/d/1sRhiaE1OFQven6MlBcvun5CDh6_X3xis" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1iKkrucgYkL4RxcpO9AZhEdkjIv9WgxKu" column=1 %}

ที่นี้ คือ ที่พักของเราในคืนนี้

{% include aligner.html images="https://lh3.googleusercontent.com/d/1kGEBJ6IQifUtIu2FrNl1KpQS82eyuVe8" column=1 %}

นอกจากผีทะเลที่ติดมาจาก กทม. ที่นี้มีแมวทะเลด้วย เขิน~

{% include aligner.html images="https://lh3.googleusercontent.com/d/1fzItJUGRGwGtMQxL2G3wEEeJqr7bORiT" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1jzMBUb7M1bXt9OAz_1vv9Sdt1hOtFrJC" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1hmNlHi-JITAlhwdc2t3OfQvUK71IPhV0" column=1 %}

เล่นน้ำ ดูปลิงทะเลก้อนดำๆได้ไม่นาน ฟ้าเริ่มมืด หมดเวลาสนุกแล้วซิ หมดเวลาสนุกแล้วซิ

{% include aligner.html images="https://lh3.googleusercontent.com/d/1V1hZUXWhqTB96XRdNfPcqqRvzPI4Wfqc" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1Zz_0d2ksFLZkshf1qKHFzx78bRoLQcy-" column=1 %}

เดินไปได้แค่นิดเดียว จัดพิซซ่ากันคนละครึ่งชิ้น แกรๆๆ ไหนซีฟู๊ดที่เมิงตั้งใจกันไว้

{% include aligner.html images="https://lh3.googleusercontent.com/d/1oSPiP_602n5aguTKGlqzuvj3icOn5vl5" column=1 %}

นี้แค่เรียกน้ำย้อย หลังจากนั้นก็เริ่มภารกิจจัดเต็มกันอย่างต่อเนื่อง กินกันจนสำราญ
{% include aligner.html images="https://lh3.googleusercontent.com/d/1bHthgqkloatMbnohhThcHUcm7Ab9HuT2" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1vgw2TMoVJzOYWE4r8f8xX_wNlaydHEGa" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/19MguGUKprOhLsneqf3nFHfaDFYDz4_J4" column=1 %}

พระอาทิตย์ตอนเช้า ค่อยๆส่องแสงขึ้นมาแล้ว มื้อเช้านี้ทางรีสอร์ทจัดไว้ให้ มีให้เลือกหลายอย่าง

{% include aligner.html images="https://lh3.googleusercontent.com/d/16WkhMlUZh80Kj6qgjv0gL5SzdSEUulUW" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1v4FFpJm2Rxwh6QbeM0TfEcSyBkqP7488" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/14zGTs40dODb5D6hlz6AlLtf2bnxJ92Qp" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1oKnCjmpgXOlFNZfHtiA-8bSxXHbn_zrj" column=1 %}

จุดแรกที่ลงน้ำ เกาะหินซ้อน หินก้อนใหญ่ซ้อนกันตามชื่อ มองลงไปใต้น้ำ น้ำใสมาก~

{% include aligner.html images="https://lh3.googleusercontent.com/d/1jvtMeFGL41QnwTfPSBqMuFsmV9PFHHOJ" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1EEoQv51Ye1c4rSL_I7SBQzcGQPKH-jO7" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1SjFBU39lzcvmsoB8o9oHHduSKqBH-Yvn" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1gLE23AeoRIb9Aap69EUm2la-MwKyAUOW" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1wfvyN2Ehnx5KRrSCfLnWVonXYwav-i9C" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/12tHXvYL0qKvSZzyxZmQkbos0OVRqldAc" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1PaR_yPJqemLtg1-2CTLEKz-Uym1S3DNq" column=1 %}

เพลินๆกันไปจนถึงเที่ยง แวะกินข้าวเที่ยงที่เกาะราวี

{% include aligner.html images="https://lh3.googleusercontent.com/d/1vlgJrkJOmrn9Xa3m5jyA5ucUUjtcOowm" column=1 %}

{% include aligner.html images="https://lh3.googleusercontent.com/d/1P1AjQ5oRjqNWXnB_0NU7mssHmXyWSp67" column=1 %}

ปูเสฉวนตัวใหญ่ เก็บไปผัดเผ็ดคืนนี้ //ผิด

{% include aligner.html images="https://lh3.googleusercontent.com/d/1cEeEssg0M4s1QlqwJbTCCC_ueStbITIi" column=1 %}

นอกจากนี้ บนเกาะยังมีเจ้าถิ่นเป็นลิงจอมซ่ามาหยิบของกินจาก นทท. (แต่ /me คิดว่า ไม่ควรให้อาหารนะ มันทำลายระบบนิเวศ)

{% include aligner.html images="https://lh3.googleusercontent.com/d/1AcQp-xgo4TKk_Nhy1MqM11IC7Mncm6ks" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1bID9xc9TIAscGnLgPFWIOr7E96kc4f1f" column=1 %}

ดูสภาพชิงๆ กำลังขึ้นเกาะ น่าสงสารไปอีก

{% include aligner.html images="https://lh3.googleusercontent.com/d/1JC6JgOasO0QcsQpTuxhj0sJMg2H_vQfP" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/105GRXaKFEO2Rs41AoPQ5Ckb1w3vpHeNd" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1lpQHA9Av4BcE-r0evjzR2EZ7aAf9vJRr" column=1 %}

ภาพที่ค่อยๆเห็น คือ ภาพปะการังสีแสดง สีม่วง สีส้ม สีน้ำเงิน นู้นนี้ ไล่เฉดสี เกาะสดใสอยู่บนโขดหิน

{% include aligner.html images="https://lh3.googleusercontent.com/d/189ZjscBmYKviSIT9KwTacCpq0EW-TDYN" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1pyoMxdwv2LDzHabdoLGmHl_Lx1e7kd5E" column=1 %}

จบทริปดำน้ำตื้นด้วยความประทับใจ แนะนำเลยว่า คุ้มค่าที่ได้มาจริงๆ

{% include aligner.html images="https://lh3.googleusercontent.com/d/1UWvr58pqhqo_hMeWIo6yHZoLMPYOtgMV" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1BUAfopvl68IYghIMJxOjAv6BpVamMt4A" column=1 %}

แด่ปลามากมายที่สละชีวิตในครั้งนี้

{% include aligner.html images="https://lh3.googleusercontent.com/d/1Hrvbm0RguL0dALXG7a-efDOMhe44fqOT" column=1 %}

มื้อสุดท้ายจบไปแล้ว กลับห้องเล่นบอร์ดเกมเป็นคืนสุดท้าย แล้วตื่นเช้าออกเดินทางกลับ กทม. บะบายหลีเป๊ะ

{% include aligner.html images="https://lh3.googleusercontent.com/d/1432_zhVoVT01GJ-IQN-6DoMyuHFnSXLA" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1tHkIQTJTg86VNU-5B6ljG6lNGmIsr-Rs" column=1 %}

วางกระเป๋าพร้อมแล้ว ภารกิจในวันนี้ คือ ตะลุยกินร้านดังแห่งเมืองหาดใหญ่ เริ่มต้นด้วย ปอเปี๊ยะแสงจันทร์(?)
{% include aligner.html images="https://lh3.googleusercontent.com/d/1mObsKXVpKP1oADNyrqpinzHmgcQQDr8h" column=1 %}

แล้วตามด้วย ไอ้คลั่งทะเลโหด จาก ร้านในรู (ร้านอยู่ในซอกหลืบจริงจัง)
{% include aligner.html images="https://lh3.googleusercontent.com/d/1hJ64dJaTzocAgL2Do0QxQX_SKBgFixnU" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1NXtsDG2LJNsYwsssiX8woPn3jsKc6CqA" column=1 %}

ตบท้ายของหวานด้วย บัวลอยไข่หวานคุณอ้น ร.ศ.219

{% include aligner.html images="https://lh3.googleusercontent.com/d/1TquzMso3WMzseLhcxzO5JAFfnWXostOK" column=1 %}
{% include aligner.html images="https://lh3.googleusercontent.com/d/1g1h0zBd-khs7K2OnUKPxYM0jONyD0sTd" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1BxrV9sJoEZn5sOj1L5i3AxxhMphSXUGv" column=1 %}
