...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1wiqlD082Harg8_32jmrtwnsFlxLgoyXB" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1OTeVVBB5RRNYIgKzgrk5P7vPFRZBG8pA" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1VzvJJZlumDz6djv9KhlXqpXNMGFzzzN1" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1yRqIs5WMEDkEk5tnF2iiQyxjO85AjCe1" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1nUw7mW3FrFb5GLD0C1QwVGl3ij9mQsoB" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1iYpYQpaEnQJ5zkanRXObMvBiU9ScuFtC" column=1 %}

แต่โต๊ะเทพกร ไม่คิดแบบนี้นะซิ สิ่งที่มันสั่ง คือ บิงซูน้ำแตงโม ราดช๊อคโกเลต สตอเบอรี่ กล๊วย +อะไรแปลกๆมีหลายอย่าง

{% include aligner.html images="https://lh3.googleusercontent.com/d/1Hs5HPt44Dv0veHPlm4MuJpXHgqq5jXFk" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1_B_EwFaXsms29lunhQgdNO2ERn1vnayI" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/18cUd6ocLF1vnRi4iIUCQBcs-WuNOfqpg" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1AKIyJ7VApXNXvKaoxh8wbySJpBobC60C" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1e9FVbJHzkxQLnEroIpHSd7Dm2usxQqGn" column=1 %}
//ยืมรูปมาจาก วาป
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1JLUX571FRb5cvGGj3j02N3NZTL6Ikj4H" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1gSawk_vMC2lWW3uoyDufh2xCulq8tTW-" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1WlMZTpyISwO_jrF6jyQEf4kAuC9pZojF" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1Un9nDdDH-7s8r1trmMq0y2HaNegaeKLJ" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1bueqGc5QBN9vrAjnzEI6yXo7SYkohHY7" column=1 %}

{% include aligner.html images="https://lh3.googleusercontent.com/d/1OXuWDGL-8qDNsE8PEyWAtlgPpN7zO9Dp" column=1 %}


ก่อนออกจากร้าน แอบ dab กันซักหน่อย

{% include aligner.html images="https://lh3.googleusercontent.com/d/1k7F1JdiYjl9OWFgdXmo4NiN_KITVw-oR" column=1 %}

หลังจากแดร๊กกันแล้ว ก็ไปแม๊คโครซื้อของตุนของสำหรับบาร์บีคิว ตื่นเต้นๆ

{% include aligner.html images="https://lh3.googleusercontent.com/d/18xcVh6gEEqlqU-DMooqHMWKIW3m8gY5I" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1H1pN4rXOznPUyvNwePrI0gFmdzd8Dpec" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1EndnlkIcWCOKEYTaxKtxdHkhVVogs-rA" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1-pGZSGp3MIHGA7EuPotvgmDNSM_6nAEr" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1s4wbecMI0T78--ElWO72pPKY-OUaoJy9" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1HtgbwNJzV85ywo4eBUFgCE0b7cRLkMqd" column=1 %}

แต่เสียดายที่ส้มตำที่ซื้อกันมา เย็นฉืดซะก่อน แถมรสชาติแดร๊กม่ายล้ายเลย ToT

{% include aligner.html images="https://lh3.googleusercontent.com/d/1tm5Il695vltSEtLEhca5zHquEkiYRFYI" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1CzC3wDzV_XgVPMzsn148yfXMB6v9oLPz" column=1 %}

คุยๆกันซักพัก ทุกๆคนก็เข้านอน วันรุ่งขึ้นก็เป็นวันสุดท้ายของทริปนี้แล้ว เฮ้ออ เร็วจัง

บรรยากาศตอนเช้าที่นี้

{% include aligner.html images="https://lh3.googleusercontent.com/d/1bJa2oYFQx_V3AGbhNt0HqdOEYCJVy2-_" column=1 %}
...
{% include aligner.html images="https://lh3.googleusercontent.com/d/1egfgs7G9rQMg_KFCO3HvceXtHGJTNbCu" column=1 %}
